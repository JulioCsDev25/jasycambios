...
<html>
    <head>
      ...
      <![endif]-->
      <title>Cambios Yrendague S.A. - Historico de Cotizaciones: Dolar, Euro, Real</title>
        <meta name="description" content="Consulte el hist&oacute;rico de la cotizaci&oacute;nes. Acceda a los datos de apertura y cierre, m&aacute;ximo, m&iacute;nimo, variaci&oacute;n y m&aacute;s.">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">  
                        <ul class="list-header-bar right">
                          <li><a href="<?php echo $ruta; ?>cotizaciones/en/">Ingles</a></li>
                          <li class="oculta-mobil">|</li>
                          <li><a href="<?php echo $ruta; ?>cotizaciones/"><b>Español</b></a></li>
                          <li class="oculta-mobil">|</li>
...
?>        
      ...
      <div id="hm-depoimentos" class="cotizaciones">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
                <br><br>
                <h1 class="center">Histórico de Cotizaciones</h1>
              
                <p style="text-align:center;"> Consulte el Historial de Cotizaciones de las principales Monedas </p>
                <br><br>
                <div class="col-md-12 col-sm-12 col-12">
                    <center>
                        ...
                        <input type="submit" value="Consultar" class="form-control" onclick="cargar_torneos();">
                    </center>
                </div>
            ...
            <div class="col-sm-12">                
                <br><br>
                <h1 class="center">Insertar cotización en tu página web</h1>
                <br><br>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <!--<iframe src="<?php echo $ruta; ?>tabla_total/"></iframe>-->
                   <iframe src="<?php echo $ruta; ?>tabla_total/" width="360" border height="490" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_total'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_total" id="ins_total">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_total/&quot; width=&quot;360"&quot; border height=&quot;490&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <iframe src="<?php echo $ruta; ?>tabla_cotiza/" width="360" border height="300" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_cotiza'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_cotiza" id="ins_cotiza">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_cotiza/&quot; width=&quot;360"&quot; border height=&quot;300&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <iframe src="<?php echo $ruta; ?>tabla_arbitraje/" width="360" border height="340" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_arbitraje'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_arbitraje" id="ins_arbitraje">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_arbitraje/&quot; width=&quot;360"&quot; border height=&quot;340&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>                                           
            </div>
          </div>
        </div>
    ...
    <link href="../assets/css/menuzord.css" rel="stylesheet" async>
    <link href="../assets/css/styles.css" rel="stylesheet" async>
    <link href="../assets/css/bandeiras.css" rel="stylesheet" async>
    ...
    <script src="../assets/js/menuzord.js" async></script>    
    <script src="../assets/js/jquery.animateNumber.min.js"></script>
    <script src="../assets/js/noframework.waypoints.js"></script>    
    <script src="../assets/js/moment.min.js"></script>      
    <script src="../assets/js/Chart.min.js"></script>
    <script src="../assets/js/lazysize.min.js" async></script>      
