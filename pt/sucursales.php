            ...
            <div class="row">
              ...
              <div class="col-sm-6">  
                <ul class="list-header-bar right">
                  <li><a href="<?php echo $ruta; ?>sucursales/en/">Ingles</a></li>
                  <li class="oculta-mobil">|</li>
                  <li><a href="<?php echo $ruta; ?>sucursales/">Español</a></li>
                  <li class="oculta-mobil">|</li>
                  <li><a href="<?php echo $ruta; ?>sucursales/pt/"><b>Portugues</b></a></li>
                </ul>    
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="">
              <div class="col-md-10 col-md-offset-1 col-xs-12 col-sm-12">
                <h1 class="center upper">Nossas agências</h1>     
                <br>
                <div class="row">
                    ...
                    <?php foreach($sucursal as $fila) { ?>
                      <div class="col-md-2 col-xs-12 col-sm-12">                      
                          <img src="<?php echo $ruta; ?>images/sucursales/<?php echo $fila['IMAGEN'];?>" style="margin-bottom:20px;margin-top:0px; border-radius:15px;" class="image img-responsive" alt="<?php echo $fila['DETALLE_SUCURSAL_PT']; ?>" />
                      </div>
                      <div class="col-md-5 col-xs-12 col-sm-12 text-justify">
                        <h4 class="text-left"><?php echo utf8_encode($fila['DETALLE_SUCURSAL_PT']);?></h4>
                        <p>
                          <strong>Horário de atendimento:</strong>  <?php echo utf8_encode($fila['HORARIOS_PT']);?> <br>
                          <strong>Endereço:</strong> <?php echo utf8_encode($fila['DIRECCION_PT']);?> <br>
                          <strong>Telefone:</strong><?php echo $fila['TELEFONO'];?> <br>
                          <?php echo utf8_encode($fila['CIUDAD_PT']);?>
                        </p>
                      </div>
                      ...
                      var misPuntos = [
                          ["<?php echo $fila['DETALLE_SUCURSAL'];?>", "<?php echo $fila['LATITUD'];?>", "<?php echo $fila['LONGITUD'];?>", "icon1", "<div height:200px;><img src=<?php echo $ruta; ?>images/sucursales/<?php echo $fila['IMAGEN'];?> style=display:table;  /><br><hr><strong><?php $fila['DETALLE_SUCURSAL_PT'];?></div>"],
                    ];
