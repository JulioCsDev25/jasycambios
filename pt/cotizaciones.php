            ...
            <div class="row">
              ...
              <div class="col-sm-6">  
                <ul class="list-header-bar right">
                  ...
                  <li class="oculta-mobil">|</li>
                  <li><a href="<?php echo $ruta; ?>cotizaciones/pt/"><b>Portugues</b></a></li>
                </ul>    
              </div>
            </div>
          </div>
      ...
      <div id="hm-depoimentos" class="cotizaciones">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
                <br><br>
                <h1 class="center upper">Histórico de cotações</h1>
                <br><br>
                <div class="col-md-12 col-sm-12 col-12">
                    <center>
                        ...
                        <input type="submit" class="form-control" value="Consultar" onclick="cargar_torneos();">
                    </center>
                </div>
            ...
            <div class="col-sm-12">                
                <br><br>
                <h1 class="center upper">Inserir cotação no seu site</h1>
                <br><br>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <!--<iframe src="<?php echo $ruta; ?>tabla_total/"></iframe>-->
                   <iframe src="<?php echo $ruta; ?>tabla_total/pt/" width="360" border height="490" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_total'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_total" id="ins_total">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_total/pt/&quot; width=&quot;360"&quot; border height=&quot;490&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <iframe src="<?php echo $ruta; ?>tabla_cotiza/pt/" width="360" border height="300" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_cotiza'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_cotiza" id="ins_cotiza">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_cotiza/pt/&quot; width=&quot;360"&quot; border height=&quot;300&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>
                <div class="mw-360 col-md-4 col-sm-12 col-xs-12">
                    <iframe src="<?php echo $ruta; ?>tabla_arbitraje/pt/" width="360" border height="340" style="overflow:hidden;" frameborder="0"></iframe>
                    <label class="copiar" onclick="copyToClipboard(document.getElementById('ins_arbitraje'));">Cópia</label>
                    <textarea rows="4" style="margin-top:5px;width:360px;font-size:12px;" name="ins_arbitraje" id="ins_arbitraje">&lt;iframe src=&quot;<?php echo $ruta; ?>tabla_arbitraje/pt/&quot; width=&quot;360"&quot; border height=&quot;340&quot; style=&quot;overflow:hidden;&quot; frameborder=&quot;0&quot;&gt;&lambda;/iframe&gt;</textarea>
                </div>                                           
            </div>
          </div>
        </div>
