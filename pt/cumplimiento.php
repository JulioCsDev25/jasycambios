            ...
            <div class="row">
              ...
              <div class="col-sm-6">  
                <ul class="list-header-bar right">
                  ...
                  <li class="oculta-mobil">|</li>
                  <li><a href="<?php echo $ruta; ?>cumplimiento/pt/"><b>Portugues</b></a></li>
                </ul>    
              </div>
            </div>
          </div>
    ...
    <div id="nosotros-slider" class="cumplimiento">
        <div class="row">
          <div class="container-fluid">
            <h1 class="center upper">COMPLIANCE</h1>              
              <br>
            <div class="row">
                <!--<div class="col-md-3">
                ...
                <div class="col-md-8 col-md-offset-2 col-xs-12">
                  <p style="text-align: justify;">Desde a sua formação, CAMBIOS YRENDAGUE SA, assumiu um firme compromisso com as políticas e os procedimentos para evitar qualquer possibilidade de que a empresa seja utilizada para fins delitivos, contribuindo com os esforços dos reguladores na aplicação de nossas leis. O departamento de Compliance é responsável por garantir que essas diretrizes sejam executadas para cumprir a legislação atual e evitar qualquer tipo de exposição negativa que possa danificar a imagem ou a reputação da empresa. E para que esse resultado seja possível é fundamental a cooperação de todos os funcionários que têm pleno conhecimento sobre a eficácia do sistema de prevenção.</p>
                  <p style="text-align: justify;">A empresa possui um Manual De Prevenção De Lavagem de Ativos e financiamento ao terrorismo, e também os manuais de Procedimentos e Funções e um Código de Ética e Conduta, que contribuem fundamentalmente para o cumprimento das leis vigentes.</p>
