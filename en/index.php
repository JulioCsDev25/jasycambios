...
<html lang="en">    
    ...
    <script>
      ...
      gtag('config', 'UA-161440115-1');
        ...
        $arr = explode("-",$sucursal[0]['DETALLE_SUCURSAL_EN']);
        $tit1 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[1]['DETALLE_SUCURSAL_EN']);
        $tit2 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[2]['DETALLE_SUCURSAL_EN']);
        $tit3 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[3]['DETALLE_SUCURSAL_EN']);
        $tit4 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[4]['DETALLE_SUCURSAL_EN']);
        $tit5 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[5]['DETALLE_SUCURSAL_EN']);
        $tit6 = utf8_encode($arr[1]);
        $arr = explode("-",$sucursal[6]['DETALLE_SUCURSAL_EN']);
        ...
        ?>
                    ...
                    <div class="row">
                      <div class="col-sm 12">
                        <ul class="list-sucursales">
                            <a onclick="ver_sucursal(0)" href="javascript:void(0);"><li class="title"><strong>Branch offices</strong></li></a>
                ...
                <div class="row">
                  <div class="container">                    
                    <div class="col-md-12 col-sm-12">
                        <div class="col-md-12 col-xs-12 col-sm-12 text-center"><p> <strong>Informative quotes and subject to change, last update <?php echo  get_ultimocambio($db); ?></strong></p></div>
                        <br>
                        <h1 class="center negro">Currency Quotation</h1>
                    </div>
                    <div class="row">                
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12" id="suc_1">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_48707346c7a9c7bd4768ce3fb54ded389.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[0]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                                <tr>
                                  ...
                                  <th class="aright" width="15%">Purchase</th>
                                  <th class="aright" width="15%">Sale</th>
                                </tr>
                              </thead>
                              <tbody>
                                  <?php 
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    ...
                                    <?php echo utf8_encode($sucursal[0]['HORARIOS_EN']); ?>  
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">                                                                            
                      ...
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12" id="suc_2">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_09f3efad807122d7bcbda5e2881d4dab.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[3]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[3]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">                                    
                      ...
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12" id="suc_6">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_80b8ab3080fa2393af86a5d528a2dabb.png) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[4]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[4]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">
                      ...
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12"  id="suc_3">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_426cde89ac8cd62cee41fb0c65a3ba8c.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[1]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>              
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">                                    
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[1]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">
                      ...
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12"  id="suc_4">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_7379a5679fc43580e45d0e6a20f29570.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[2]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[2]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">
                      ...
                      <div class="img-bg col-md-6 col-xs-12 col-sm-12"  id="suc_5">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_9307384e81d6ea76d5daa298b03381f9.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[5]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[5]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">
                        ...
                        <div class="img-bg col-md-6 col-xs-12 col-sm-12"  id="suc_7">
                        <div class="cotacao-box">
                          <div class="title" style="/*background: url(assets/arquivos/sucursais/m_9307384e81d6ea76d5daa298b03381f9.jpg) center center no-repeat #000*/">
                            <h1><?php echo utf8_encode($sucursal[6]['DETALLE_SUCURSAL_EN']); ?></h1>
                          </div>
                          <div class="conteudo">
                            <table class="table-cotacao">
                              <thead>
                            ...
                            <div class="infos">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  ...
                                  <div class="desc">
                                    <strong>Opening Hours:</strong><br>
                                    <?php echo utf8_encode($sucursal[6]['HORARIOS_EN']); ?>
                                  </div>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                  <div class="ico">
            ...
            <?php 
              ...
              <div id="hm-depoimentos">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-12">
                        <h1 class="center">Quotation History <small>Below you can see and compare the graph of the history of the currencies.</small></h1>                
                ...
                <div class="container">
                  ...
                  <div class="col-md-4" id="img-ser-1">
                      <div class="m_servicios">
                        ...
                        <h2>Buying and selling currencies</h2>
                        <p>We offer services of foreign currency exchange, currency quotes at the best market price, arbitration.
                        </p>
                      </div>
                  </div>
                  <div class="col-md-4" id="img-ser-2">
                      <div class="m_servicios">
                        ...
                        <h2>Money orders and transfers</h2>
                        <p>Make money transfers to different destinations around the world, we also offer National Money Order service.</p>
                      </div>
                  </div>
                  <div class="col-md-4" id="img-ser-3">
                      <div class="m_servicios">
                        ...
                        <h2>Business and Family Safety Boxes</h2>
                        <p>We offer rental services of Safety Boxes. it is designed with the purpose of storing and protecting items of value or great importance.</p>            
                      </div>
                  </div>          
                  <br>
                </div>
            ...
            <div class="calculadora-app hidden-xs" title="Click para fijarlo" id="calculadora-app">
                ...
                <div class="">
                    <table>
                        <tr>
                            <td colspan="2">COIN CONVERTER</td>                            
                        </tr>
                        <tr>
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <p>
                            By <a href="https://variablet.com/" target="_blank" title="If you got here it is because you liked the site, meet us!"><img src="https://www.variablet.com/assets/img/variablet.png" width="90px"></a>
                        </p>
                    </div>
                  </div>    
                </div>
